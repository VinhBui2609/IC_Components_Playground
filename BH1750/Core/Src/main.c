...
//
//	}
//	HAL_I2C_Master_Receive_IT(&hi2c1, ADDR_LOW_ADDRESS_READ, buffer, 2);
//}
...
//	HAL_Delay(1000);
//
//	while(HAL_I2C_Master_Transmit(&hi2c1, ADDR_LOW_ADDRESS_WRITE, (uint8_t*)POWER_ON, 1, 120) != HAL_OK);
//	__HAL_I2C_CLEAR_FLAG(&hi2c1, I2C_FLAG_STOPF);
//	HAL_Delay(100);
//	while(HAL_I2C_Master_Transmit(&hi2c1, ADDR_LOW_ADDRESS_WRITE, (uint8_t*)RESET, 1, 120) != HAL_OK);
//	__HAL_I2C_CLEAR_FLAG(&hi2c1, I2C_FLAG_STOPF);
//	HAL_Delay(100);
//	while(HAL_I2C_Master_Transmit(&hi2c1, ADDR_LOW_ADDRESS_WRITE, (uint8_t*)CON_H_RES_MODE, 1, 120) != HAL_OK);
//	__HAL_I2C_CLEAR_FLAG(&hi2c1, I2C_FLAG_STOPF);
//	HAL_Delay(100);
...
//	HAL_I2C_Master_Receive_IT(&hi2c1, ADDR_LOW_ADDRESS_READ, buffer, 2);
  ...
  while (1)
  {
//	HAL_I2C_Master_Receive(&hi2c1, ADDR_LOW_ADDRESS_READ, buffer, 2, 1000);
//	HAL_Delay(100);
//
//	value = ((buffer[0] << 8) | buffer[1]);
//	value /= 1.2;
